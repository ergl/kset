...
(* OASIS_START *)
(* DO NOT EDIT (digest: acdc66f902f1a7477bb4f00876d4aa68) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./kset_test.byte", []))];
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Borja o'Cook"];
          homepage = None;
          bugreports = None;
          synopsis = "Key-set implementation for antidote-sql";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Kset_internal"];
                      lib_pack = false;
                      lib_internal_modules = ["B64"; "Encoding"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "kset_test.ml"});
               Test
                 ({
                     cs_name = "relkv_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\024\151%\239{\171'\028\218y\253E\135,*\148";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
